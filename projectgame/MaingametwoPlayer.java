 ...
 * @author Naisu
 */
public class MaingametwoPlayer extends JFrame implements KeyListener,MouseListener{

    private JPanel contentpane;
    private int numbericonsanta, numbericongrinch, delay;
    ...
    public MaingametwoPlayer(int numbericonsanta, int numbericongrunch, int delay,String namePlayer1,String namePlayer2,String colorbackground,String colorladder,int sound,int soundeffect) {
        this.colorbackground = colorbackground;
        this.colorladder = colorladder;
        this.namePlayer1 = namePlayer1;
        this.namePlayer2 = namePlayer2;
        this.numbericonsanta = numbericonsanta;
        this.numbericongrinch = numbericongrunch;
        this.delay = delay;        
        ...
        System.out.println(numbericonsanta + "  " + numbericongrunch + "  " + delay);
        setLocation();
        add_component();
        selectPlayerToStart();
    ...
    public void add_component() {
        ...
        grinchpicgameMode = new MyImageIcon("resource/grinch" + (numbericongrinch + 1) + ".png").resize(35, 35);
        ...
        namePlayerlb2 = new JLabel(namePlayer2);
        namePlayerlb2.setBounds(850,230,190,210);
        namePlayerlb2.setFont(new Font("TimesRoman", Font.BOLD, 20));
        namePlayerlb2.setForeground(Color.WHITE);
        ...
        GreenGiveup = new JLabel(GreenGiveupImg);
        GreenGiveup.setBounds(910, 490, 80, 80);
        GreenGiveup.addMouseListener(this);
    ...
    public void keyTyped(KeyEvent e) {
        ...
        if (playercount2 == 1 && e.getKeyChar() == KeyEvent.VK_ENTER) {
            grinchturn();
        }
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        else if(e.getSource() == GreenGiveup){
            GreenGiveup.setIcon(new MyImageIcon("resource/greenGiveupBright.png").resize(80, 80));
        }
    }
    ...
    if(e.getSource() == RedGiveup){
            ...
            GreenGiveup.setIcon(GreenGiveupImg);
        }
    }
