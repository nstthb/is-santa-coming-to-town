...
public class MainApplication extends JFrame implements ItemListener,ActionListener {
    ...
    private JLabel thirdPane,soundoption,bgcolour,delayofchar,blue,purple,yellow;
    ...
    public void Dialog_setting() {
        ...
        delayofchar = new JLabel("  DELAY OF CHARACTER ");
        delayofchar.setFont(headfont);
        thirdPanel.add(delayofchar);
        ...
        speedSlider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                thirdPane.setText("Delay of the slider is: " + ((JSlider) e.getSource()).getValue() + " ms");
        ...
        introducepane.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (countclick == 0) {
                    ...
                    choosenumberPlayer c = new choosenumberPlayer(delay,colorBackground,colorladder,soundchoose,soundeffectchoose);
                    setVisible(false);
                    dispose(); 
                    jinglebellSound.stop();
