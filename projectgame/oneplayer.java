...
public class oneplayer extends JFrame implements KeyListener, MouseListener {
    ...
    private int numbericonsanta, delay;
    ...
    public oneplayer(int numbericonsanta, int delay, String namePlayer1, String colorbackground, String colorladder, int sound, int soundeffect) {
